...
comandos() {
declare ficheiro="/media/sdc1/volatility_"$disco$(date +"%Y-%m-%d_%H-%M-%S")"_lista_rede.txt"

cd /media/sdb1

executa "Netscan - Análise a ligações de rede ativas" vol.py -f 20200601.mem --profile=Win10x64_10586 netscan

}

touch $ficheiro
escreveSecao "Ligações de rede ativas"
comandos
